...
{
    /// <summary>
    ///     http://stackoverflow.com/a/18859034/4025704
    /// </summary>
    internal class StringCompIgnoreWhiteSpace : IEqualityComparer<string>
    {
        public bool Equals(string strx, string stry)
        {
            ...
            if (stry == null) //strx may contain only whitespace
